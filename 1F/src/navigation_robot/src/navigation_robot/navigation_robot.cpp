...
void KobukiManager::PublishRobotState()
{
  ...
  pub_msg.pos.theta = kalman_pose_heading - 2.0 * global_QR_heading_n * ecl::pi;
...
** this function is looped after proglam was paformed kobuki.enable()
*****************************************************************************/
void KobukiManager::processStreamData()
{
  ...
  if (get_robot_mode() == "Navi")
  {
    ...
    //    if ((last_kalman_heading - 2.0*global_kalman_heading_n * ecl::pi) -
    //    (kalman_pose_heading - 2.0*global_kalman_heading_n * ecl::pi) >
    //    ecl::pi * 1.5)
    //      global_kalman_heading_n++;
    //    else if ((last_kalman_heading -2.0 * global_kalman_heading_n *
    //    ecl::pi) - (kalman_pose_heading-2.0 * global_kalman_heading_n *
    //    ecl::pi) < (-ecl::pi * 1.5))
    //      global_kalman_heading_n--;
    ...
    cout << iso_time_str << ", " << setw(12) << left << kalman_pose.x() << ", "
         << setw(12) << left << kalman_pose.y() << ", " << setw(12) << left
         << kalman_pose_heading << ", " << setw(13) << left << global_v << ", "
