...
#define ANGULAR_PARAM 1.5
#define FILENAME "/home/turtle1/ros/src/navigation_robot/src/dist.txt" // you should modify to your environment
...
/*****************************************************************************
**** class PathPoint
**** This class is define destination set represented direction and distance.
*****************************************************************************/
class PathPoint
{
private:
...
/*****************************************************************************
**** class Route
**** This class is define the list of PathPoints and its reverse.
*****************************************************************************/
class Route
...
/*****************************************************************************
**** class KobukiManager
**** This class Managed Kobuki and many variables. (initialize and control)
**** Route class and PassPoint class are used.
*****************************************************************************/
class KobukiManager
{
public:
...
**** This function is impremented kalman filter to integrate odometry and QR code.
*****************************************************************************/
